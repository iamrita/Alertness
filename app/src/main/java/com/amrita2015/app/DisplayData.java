...
public class DisplayData extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userData = (TextView)findViewById(R.id.showData);
        Intent prevIntent = this.getIntent();
        data = (String)prevIntent.getStringExtra("data");
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_display_data, container, false);
            return rootView;
        }
    }
